            ...
            <div className="w-full max-w-[880px] relative flex flex-col-reverse md:flex-row  items-end">
              <div className="absolute bg-black min-h-[280px] md:min-h-[360px] md:w-[340px] w-full -mb-5 md:right-3  md:m-0 md:bottom-3 z-10 text-transparent px-6 py-8">
                ...
                <p className="text-sm">
                  ...
                  functional elements can be added in our process so that
                  assembly steps are eliminated. Innovative ideas like integral
                  lighting and sensors are not out of the question. Contact us
                  and let us build what you need.
                </p>
              </div>
            ...
            <div className="w-full max-w-[980px] relative flex flex-col-reverse md:flex-row  items-end">
              <div className="absolute bg-black min-h-[220px] md:min-h-[360px] md:w-[340px] w-full -mb-5 md:right-3  md:m-0 md:bottom-3 z-10 text-transparent px-6 py-8">
                ...
                <p className="text-sm">
                  ...
                  composites in minimal time. We also have the ability to 3D
                  scan your existing or obsolete parts to create new designs
                  that meet or exceed the performance of the old.
                </p>
              </div>
            ...
            <div className="w-full max-w-[980px] relative flex flex-col-reverse md:flex-row  items-end">
              <div className="absolute bg-black min-h-[200px] md:min-h-[360px] md:w-[340px] w-full -mb-5 md:right-3  md:m-0 md:bottom-3 z-10 text-transparent px-6 py-8">
                ...
                <p className="text-sm">
                  ...
                  ut ex at urna cursus pellentesque. Morbi tellus arcu,
                  fringilla in aliquet a, ullamcorper sed mauris. Praesent
                  aliquet elit quis ante mattis molestie. Fusce sed posuere
                  sapien, ut sagittis arcu. Nullam eget mi et felis lobortis
                  tincidunt et commodo libero.
                </p>
              </div>
