...
const AboutCard2 = () => {
  ...
  return (
    <motion.div ref={ref} animate={controls} variants={squareVariants}>
      <div
        id="2"
      ...
      <div className="w-screen md:h-screen md:overflow-hidden font-Poppins">
        ...
        >
          <div className="w-full max-w-sm text-white p-4">
            ...
            <p className="">
              Lightweight Composite Materials was created to deliver custom
              products tailored to your designs. We partner with you early in
              the design phase so that our composites are delivered as 'ready to
              use' as possible. Advances in technologies coupled with our
              philosophy mean that you don't have to settle for off the shelf
              solutions.
            </p>
          </div>
        </div>
          ...
          >
            <div className="w-full max-w-xl text-white">
              ...
              <p className="">
                ...
                libero. Nam ac maximus velit, id tristique nisi. Fusce eget
                aliquet dui.
              </p>
            </div>
          </div>
